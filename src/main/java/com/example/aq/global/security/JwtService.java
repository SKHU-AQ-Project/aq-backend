...
public class JwtService {
    ...
    @Value("${jwt.secretKey:mySecretKey123456789012345678901234567890}")
    ...
    @Value("${jwt.access.header:Authorization}")
    private String accessHeader;

    @Value("${jwt.refresh.header:RefreshToken}")
    ...
    public String verifyTokenAndGetEmail(String token) {
        try {
            ...
            throw new GeneralException("EXPIRED_TOKEN", "만료된 토큰입니다.");
